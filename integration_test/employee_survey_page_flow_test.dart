  ...
  group('employee_survey_page.dart flow (integration)', () {
    group('pairwise_valid_invalid_cases', () {
      testWidgets('pairwise_valid_invalid_cases_1', (tester) async {
        ...
        await tester.enterText(find.byKey(const Key('employee_02_id_textfield')), 'EMP-1234');
        await tester.pump();
        ...
        await tester.enterText(find.byKey(const Key('employee_04_email_textfield')), 'john.doe@techcorp.com');
        await tester.pump();
        // dataset: byKey.employee_05_years_textfield[0].invalid
        await tester.enterText(find.byKey(const Key('employee_05_years_textfield')), '51');
        await tester.pump();
      ...
      testWidgets('pairwise_valid_invalid_cases_2', (tester) async {
        ...
        await tester.enterText(find.byKey(const Key('employee_02_id_textfield')), 'EMP-78901');
        await tester.pump();
        await tester.ensureVisible(find.byKey(const Key('employee_03_department_dropdown')));
        await tester.tap(find.byKey(const Key('employee_03_department_dropdown')));
        await tester.pump();
        ...
        await tester.enterText(find.byKey(const Key('employee_04_email_textfield')), 'john.doe@techcorp');
        await tester.pump();
        // dataset: byKey.employee_05_years_textfield[0].valid
        await tester.enterText(find.byKey(const Key('employee_05_years_textfield')), '15');
        await tester.pump();
