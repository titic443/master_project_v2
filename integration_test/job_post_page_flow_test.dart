  ...
  group('job_post_page.dart flow (integration)', () {
    group('pairwise_valid_invalid_cases', () {
      ...
      testWidgets('pairwise_valid_invalid_cases_2', (tester) async {
        ...
        await tester.enterText(find.byKey(const Key('job_08_salary_max_textfield')), '75000');
        await tester.pump();
        // dataset: byKey.job_09_desc_textfield[0].invalid
        await tester.enterText(find.byKey(const Key('job_09_desc_textfield')), 'Need more details');
        await tester.pump();
    ...
    group('edge_cases', () {
      ...
      testWidgets('edge_cases_boundary_at_min_length', (tester) async {
        ...
        await tester.enterText(find.byKey(const Key('job_09_desc_textfield')), 'This is too short...');
        await tester.pump();
