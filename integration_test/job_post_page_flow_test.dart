  ...
  group('job_post_page.dart flow (integration)', () {
    group('pairwise_valid_invalid_cases', () {
      testWidgets('pairwise_valid_invalid_cases_1', (tester) async {
        ...
        await tester.enterText(find.byKey(const Key('job_02_company_textfield')), 'Tech Solutions Inc.');
        await tester.pump();
        ...
        await tester.enterText(find.byKey(const Key('job_07_salary_min_textfield')), '100');
        await tester.pump();
        ...
        await tester.enterText(find.byKey(const Key('job_09_desc_textfield')), 'We are seeking a highly skilled Flutter developer ');
        await tester.pump();
      ...
      testWidgets('pairwise_valid_invalid_cases_2', (tester) async {
        ...
        await tester.enterText(find.byKey(const Key('job_01_title_textfield')), 'Senior Software Engineer (Flutter/Dart)');
        await tester.pump();
        ...
        await tester.enterText(find.byKey(const Key('job_08_salary_max_textfield')), '100000');
        await tester.pump();
        // dataset: byKey.job_09_desc_textfield[0].invalid
        await tester.enterText(find.byKey(const Key('job_09_desc_textfield')), 'Short job description for a new role.');
        await tester.pump();
        // dataset: byKey.job_10_skills_textfield[0].valid
        await tester.enterText(find.byKey(const Key('job_10_skills_textfield')), 'Flutter, Dart, Firebase, REST APIs, Git');
        await tester.pump();
    ...
    group('edge_cases', () {
      ...
      testWidgets('edge_cases_boundary_at_min_length', (tester) async {
        ...
        await tester.enterText(find.byKey(const Key('job_01_title_textfield')), 'De');
        await tester.pump();
        // dataset: byKey.job_02_company_textfield[0].atMin
        await tester.enterText(find.byKey(const Key('job_02_company_textfield')), 'C');
        await tester.pump();
        // dataset: byKey.job_03_location_textfield[0].atMin
        await tester.enterText(find.byKey(const Key('job_03_location_textfield')), 'L');
        await tester.pump();
        await tester.ensureVisible(find.byKey(const Key('job_04_category_dropdown')));
        await tester.tap(find.byKey(const Key('job_04_category_dropdown')));
        await tester.pump();
        ...
        await tester.enterText(find.byKey(const Key('job_09_desc_textfield')), 'Short job description.');
        await tester.pump();
