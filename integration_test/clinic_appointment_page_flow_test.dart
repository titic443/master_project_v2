  ...
  group('clinic_appointment_page.dart flow (integration)', () {
    group('pairwise_invalid_cases', () {
      testWidgets('pairwise_invalid_cases_1', (tester) async {
        ...
        await tester.enterText(find.byKey(const Key('appt_01_patient_name_textfield')), 'John Doe123');
        await tester.pump();
        // dataset: byKey.appt_02_id_card_textfield[0].invalid
        await tester.enterText(find.byKey(const Key('appt_02_id_card_textfield')), '12345');
        await tester.pump();
        // dataset: byKey.appt_03_phone_textfield[0].invalid
        await tester.enterText(find.byKey(const Key('appt_03_phone_textfield')), '1234567890');
        await tester.pump();
        ...
        await tester.pumpAndSettle();
        // Select date: 01/01/2020 (text input mode)
        {
          ...
          if (tester.any(dateTF)) {
            ...
            await tester.pumpAndSettle();
            await tester.enterText(dateTF.first, '01/01/2020');
            await tester.pumpAndSettle();
          }
        }
        ...
        }
        {
          ...
          if (dialogTF.evaluate().length >= 1) {
            ...
            await tester.pumpAndSettle();
            await tester.enterText(dialogTF.first, '21');
            await tester.pumpAndSettle();
          }
        ...
        final expected = [
          ...
          find.text('ไม่สามารถนัดหมายวันที่ผ่านมาแล้ว'),
          find.text('เวลาเปิดให้บริการ 08:00–20:00 น.'),
    ...
    group('pairwise_valid_cases', () {
      testWidgets('pairwise_valid_cases_1', (tester) async {
        ...
        await tester.tap(find.byKey(const Key('appt_06_date_textfield')));
        await tester.pumpAndSettle();
        // Select date: 12/06/2026 (text input mode)
        {
          await tester.pumpAndSettle(const Duration(milliseconds: 500));
          // Switch DatePicker to text-input mode via edit icon
          final editIcon = find.byIcon(Icons.edit);
          ...
          if (tester.any(dateTF)) {
            await tester.tap(dateTF.first);
            await tester.pumpAndSettle();
            await tester.enterText(dateTF.first, '06/12/2026');
            await tester.pumpAndSettle();
          }
        }
        await tester.tap(find.text('OK'));
        ...
        await tester.enterText(find.byKey(const Key('appt_09_note_textfield')), 'อาการปวดหัวเป็นมา 3 วัน');
        await tester.pump();
        FocusManager.instance.primaryFocus?.unfocus();
        await tester.pumpAndSettle();
        await tester.ensureVisible(find.byKey(const Key('appt_10_confirm_button')));
    ...
    group('edge_cases', () {
      ...
      testWidgets('edge_cases_boundary_at_max_length', (tester) async {
        ...
        await tester.enterText(find.byKey(const Key('appt_01_patient_name_textfield')), 'สุดารัตน์ เจริญสุขมงคลกุล กิตติพงษ์พาณิชย์สุขสวัสด');
        await tester.pump();
        ...
        await tester.enterText(find.byKey(const Key('appt_09_note_textfield')), 'คนไข้มีอาการปวดหัวเรื้อรัง เป็นมานาน 3 วัน พบรอยฟก');
        await tester.pump();
        FocusManager.instance.primaryFocus?.unfocus();
        await tester.pumpAndSettle();
        await tester.ensureVisible(find.byKey(const Key('appt_10_confirm_button')));
      ...
      testWidgets('edge_cases_boundary_at_min_length', (tester) async {
        ...
        await tester.enterText(find.byKey(const Key('appt_09_note_textfield')), 'ก');
        await tester.pump();
        FocusManager.instance.primaryFocus?.unfocus();
        await tester.pumpAndSettle();
        await tester.ensureVisible(find.byKey(const Key('appt_10_confirm_button')));
