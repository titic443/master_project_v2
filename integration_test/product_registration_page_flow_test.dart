  ...
  group('product_registration_page.dart flow (integration)', () {
    group('pairwise_valid_invalid_cases', () {
      testWidgets('pairwise_valid_invalid_cases_1', (tester) async {
        ...
        await tester.enterText(find.byKey(const Key('product_02_name_textfield')), '');
        await tester.pump();
        ...
        await tester.enterText(find.byKey(const Key('product_04_sku_textfield')), '');
        await tester.pump();
        // dataset: byKey.product_05_quantity_textfield[0].valid
        await tester.enterText(find.byKey(const Key('product_05_quantity_textfield')), '');
        await tester.pump();
